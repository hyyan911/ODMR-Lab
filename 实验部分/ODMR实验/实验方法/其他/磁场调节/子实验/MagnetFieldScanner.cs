...
namespace ODMR_Lab.实验部分.ODMR实验.实验方法.其他.磁场调节.子实验
{
    ...
    class MagnetFieldScanner : ODMRExperimentWithoutAFM
    {
        ...
        public override List<ParamB> InputParams { get; set; } = new List<ParamB>()
        {
            ...
            new Param<double>("扫描高度",13.5,"ScanHeight"),
            new Param<double>("扫描宽度(MHz)",30,"ScanWidth"),
        };
        ...
        {
            //移动位移台
            MagnetScanTool.CalculatepPredictLoc(Ps, GetInputParamValueByName("ScanHeight"), arg4.X, arg4.Y, out double x, out double y, out double z, out double angle);
            ...
            MagnetScanTool.ScanCW2(this, 0, out double peakout1, out double peakout2, out double contrastout1, out double contrastout2, out List<double> freqs, out List<double> contrasts, (double)arg5[0], (double)arg5[1], (int)GetInputParamValueByName("ScanWidth"));
