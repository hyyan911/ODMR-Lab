...
namespace ODMR_Lab.实验部分.ODMR实验.实验方法.AFM.二维扫描
{
    public class Confocal : Scan2DExpBase<NanoStageInfo, NanoStageInfo>
    {
        ...
        public override string ODMRExperimentGroupName { get; set; } = "实空间面实验(AFM)";
        ...
        public override List<KeyValuePair<DeviceTypes, Param<string>>> DeviceList { get; set; } = new List<KeyValuePair<DeviceTypes, Param<string>>>()
        {
            ...
            new KeyValuePair<DeviceTypes, Param<string>>(DeviceTypes.PulseBlaster,new Param<string>("LockIn","","LockIn")),
        };
